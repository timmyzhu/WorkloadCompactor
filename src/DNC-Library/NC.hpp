...
struct Flow {
    ...
    bool ignoreLatency; // Ignore flow for the purposes of latency; only relevant for checking overload conditions
};
...
struct Client {
    ...
    bool ignoreLatency; // Ignore client for the purposes of latency; only relevant for checking overload conditions
};
